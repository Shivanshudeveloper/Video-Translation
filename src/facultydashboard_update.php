...
$sql = "UPDATE users SET mother_tounge = '$motherTounge', mother_tounge_lang = '$motherToungueLanguage', institute_state = '$stt', aicte_approved = '$isAicteApproved', institute_name = '$institute', cleansing = '$cleansing', validator = '$validator', year_experience = '$experience', domain = '$domain' WHERE email = '$email';";
echo $sql;
